...
# 1. 获取当月排产工单（site_ref=410, ship_date在当月）
sql_erp = """
...
print(f"当月排产工单数(410): {len(df_erp)}")
...
output_file = 'C:/Users/guangli.wang/Desktop/410_包装累计完成销售工单明细.xlsx'
