...
# -*- coding: utf-8 -*-
"""
销售目标数据同步脚本（Penang 410站点）
从 Excel 读取数据，同步到 erp_data.hmlv_sales_target_v2 表（siteref=410）
可单独运行，也可被定时任务调用
...
注意: 所有记录固定写入 siteref=410（410站点），查询/更新也只针对410站点
"""
...
EXCEL_PATH = r'I:/Production/01 Cor&Fiber Production/14-手工排产/AI排产文件夹 - 马来/销售目标.xlsx'
TABLE_NAME = 'hmlv_sales_target_v2'
SITEREF = 410  # 本脚本固定同步410站点数据
